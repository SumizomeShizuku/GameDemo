...
public class Constants {
    ...
    // 总种族数
    public static final int TOTAL_ETHNICITY_NUM = 4;
    // 默认种族
    public static final EthnicityList DEFAULT_ETHNICITY = EthnicityList.KITSARIEL;
    // 总职业数
    public static final int TOTAL_JOB_NUM = 4;
    // 默认职业
