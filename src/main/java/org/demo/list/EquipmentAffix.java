...
public enum EquipmentAffix {
    ...
    // region 04 風神
    FUJIN_IBUKI_I("風神ノ息吹 I", 1, 1000, 1000, m(Attribute.ACCURACY, 0.02, BonusType.ADD), m(Attribute.EVASION, 0.02, BonusType.ADD)),
    FUJIN_IBUKI_II("風神ノ息吹 II", 2, 1000, 450, m(Attribute.ACCURACY, 0.04, BonusType.ADD), m(Attribute.EVASION, 0.04, BonusType.ADD)),
    FUJIN_IBUKI_III("風神ノ息吹 III", 3, 1000, 180, m(Attribute.ACCURACY, 0.06, BonusType.ADD), m(Attribute.EVASION, 0.06, BonusType.ADD)),
    FUJIN_IBUKI_IV("風神ノ息吹 IV", 4, 1000, 45, m(Attribute.ACCURACY, 0.08, BonusType.ADD), m(Attribute.EVASION, 0.08, BonusType.ADD)),
    FUJIN_IBUKI_V("風神ノ息吹 V", 5, 1000, 10, m(Attribute.ACCURACY, 0.10, BonusType.ADD), m(Attribute.EVASION, 0.10, BonusType.ADD)),
    // region 05 雷神
    ...
    // region 08 猿田彦
    SARUTAHIKO_MICHIBIKI_I("猿田彦ノ導き I", 1, 1000, 1000, m(Attribute.ACCURACY, 0.03, BonusType.ADD), m(Attribute.RECOVER_HP, 1, BonusType.ADD)),
    SARUTAHIKO_MICHIBIKI_II("猿田彦ノ導き II", 2, 1000, 450, m(Attribute.ACCURACY, 0.06, BonusType.ADD), m(Attribute.RECOVER_HP, 2, BonusType.ADD)),
    SARUTAHIKO_MICHIBIKI_III("猿田彦ノ導き III", 3, 1000, 180, m(Attribute.ACCURACY, 0.09, BonusType.ADD), m(Attribute.RECOVER_HP, 3, BonusType.ADD)),
    SARUTAHIKO_MICHIBIKI_IV("猿田彦ノ導き IV", 4, 1000, 45, m(Attribute.ACCURACY, 0.12, BonusType.ADD), m(Attribute.RECOVER_HP, 4, BonusType.ADD)),
    SARUTAHIKO_MICHIBIKI_V("猿田彦ノ導き V", 5, 1000, 10, m(Attribute.ACCURACY, 0.15, BonusType.ADD), m(Attribute.RECOVER_HP, 5, BonusType.ADD)),
    // region 09 イザナギ
    ...
    // region 11 志那都彦
    SHINATSUHIKO_SEIFU_I("志那都彦ノ清風 I", 1, 1000, 1000, m(Attribute.FORTITUDE, 1, BonusType.ADD), m(Attribute.ACCURACY, 0.01, BonusType.ADD)),
    SHINATSUHIKO_SEIFU_II("志那都彦ノ清風 II", 2, 1000, 450, m(Attribute.FORTITUDE, 2, BonusType.ADD), m(Attribute.ACCURACY, 0.02, BonusType.ADD)),
    SHINATSUHIKO_SEIFU_III("志那都彦ノ清風 III", 3, 1000, 180, m(Attribute.FORTITUDE, 3, BonusType.ADD), m(Attribute.ACCURACY, 0.03, BonusType.ADD)),
    SHINATSUHIKO_SEIFU_IV("志那都彦ノ清風 IV", 4, 1000, 45, m(Attribute.FORTITUDE, 4, BonusType.ADD), m(Attribute.ACCURACY, 0.04, BonusType.ADD)),
    SHINATSUHIKO_SEIFU_V("志那都彦ノ清風 V", 5, 1000, 10, m(Attribute.FORTITUDE, 5, BonusType.ADD), m(Attribute.ACCURACY, 0.05, BonusType.ADD)),
    // region 12 琴平
    ...
    // region 30 天狐
    TENKO_SHIEN_I("天狐ノ思縁 I", 1, 1000, 1000, m(Attribute.LUCK, 3, BonusType.ADD), m(Attribute.ACCURACY, 0.01, BonusType.ADD)),
    TENKO_SHIEN_II("天狐ノ思縁 II", 2, 1000, 450, m(Attribute.LUCK, 6, BonusType.ADD), m(Attribute.ACCURACY, 0.02, BonusType.ADD)),
    TENKO_SHIEN_III("天狐ノ思縁 III", 3, 1000, 180, m(Attribute.LUCK, 9, BonusType.ADD), m(Attribute.ACCURACY, 0.03, BonusType.ADD)),
    TENKO_SHIEN_IV("天狐ノ思縁 IV", 4, 1000, 45, m(Attribute.LUCK, 12, BonusType.ADD), m(Attribute.ACCURACY, 0.04, BonusType.ADD)),
    TENKO_SHIEN_V("天狐ノ思縁 V", 5, 1000, 10, m(Attribute.LUCK, 15, BonusType.ADD), m(Attribute.ACCURACY, 0.05, BonusType.ADD)),
    // region 31 天鈿女
