...
public enum JobList {
     ...
     * 战士
     */
    WARRIOR(0, 1, 45, 12, 1, new double[]{0.6, 0.2, 0.2}, "战士"),
    /**
     * 法师
     */
    MAGE(0, 1, 22, 30, 1, new double[]{0.2, 0.2, 0.6,}, "法师"),
    /**
     * 游侠
     */
    ARCHER(0, 1, 37, 16, 1, new double[]{0.4, 0.5, 0.1,}, "游侠"),
    /**
     * 圣职者
     */
    CLERIC(0, 1, 28, 26, 1, new double[]{0.3, 0.2, 0.5,}, "圣职者");
